...
const SETTINGS_OPERATIONS: SettingsWorkspaceData["operations"] = [
  {
    ...
    nextStep: "Queue a guarded recalculation request with optional date range so downstream processing can run under controlled review.",
  },
  {
    ...
    nextStep: "Queue a guarded reprocess request with explicit batch ID to preserve traceability before replay execution.",
  },
  {
