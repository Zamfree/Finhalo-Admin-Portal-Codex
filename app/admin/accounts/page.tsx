...
import {
  getAdminAccountActivitySummaryMap,
  getAdminAccounts,
...
export default async function AccountsPage() {
  ...
  const activityByAccountId = await getAdminAccountActivitySummaryMap(
  ...
  return (
    <div className="space-y-5 pb-8 xl:space-y-6">
      ...
      >
        <AccountsPageClient rows={rows} activityByAccountId={activityByAccountId} />
      </DataPanel>
    </div>
  );
}
