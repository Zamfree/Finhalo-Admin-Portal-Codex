...
export default async function FinanceLedgerPage({ searchParams }: FinancePageProps) {
  ...
  const hasFilters = Boolean(userId || transactionType || fromDate || toDate);
    ...
    <div className="space-y-4">
      <section className="rounded-lg border bg-background p-4 shadow-sm">
        ...
        <form className="grid gap-3 md:grid-cols-5 md:items-end">
          ...
          <button type="submit" className="rounded-md bg-primary px-3 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity">
            Apply filters
          </button>
        </form>
      </section>
