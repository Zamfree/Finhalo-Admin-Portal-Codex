...
export default async function LoginPage() {
  return (
    <main className="flex min-h-screen items-center justify-center p-6 md:p-10">
      <section className="relative w-full max-w-6xl overflow-hidden rounded-[28px] border border-white/10 bg-[#0f0f0f]/95 shadow-[0_30px_80px_rgba(0,0,0,0.55)] backdrop-blur-2xl">
        <div className="pointer-events-none absolute -left-24 -top-24 h-64 w-64 rounded-full bg-emerald-500/15 blur-[90px]" />
        ...
        <div className="grid gap-0 lg:grid-cols-2">
          <div className="border-b border-white/5 p-8 md:p-12 lg:border-b-0 lg:border-r">
            <p className="mb-6 inline-flex rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-emerald-400">
              Finhalo Admin
            </p>
            ...
            <form className="space-y-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-white/10 bg-[#1a1a1a] px-4 text-sm text-white placeholder:text-zinc-600 outline-none transition focus:border-emerald-500/50"
                />
              </div>
